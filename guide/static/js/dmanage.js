    ...
    function init() {
        ...
        function calculateDistance() {
            ...
            {
                alert($('#id_pickup_adrs option:selected').text()+"  "+$('#id_delivery_adrs option:selected').text());
                return;
            }
            ...
            if ($('#id_pickup_adrs').val() == $('#id_delivery_adrs').val())
            {
                ...
                $('#id_pickup_adrs option:selected').remove();
                $('#id_delivery_adrs option:selected').remove();
        ...
        function calculateCharges() {
            ...
            var rate_message = "Proceed and pay approx. USD " + shipping_charge+"?";
