    ...
    function callback (response, status, mode) {
            if (status != google.maps.DistanceMatrixStatus.OK) {
                ...
                if (response.rows[0].elements[0].status === "ZERO_RESULTS") {
                    ...
                    if (mode == "DRIVING") {
                    console.log(distance_in_mile+" callabck without rounding "+duration_value);
                    $("#id_driving_distance").val(distance_in_mile.toFixed(3));
                    $("#id_driving_duration").val(duration_value.toFixed(3));
                    ...
                    $("#id_bicycling_duration").val(duration_value.toFixed(3));
                    
                  }   else{
                    console.log(distance_in_mile+" callabck "+duration_value);
                    $("#id_transit_distance").val(distance_in_mile.toFixed(3));
                    $("#id_transit_duration").val(duration_value.toFixed(3));
                  }           
                }
