...
class Topic(models.Model):
    ...
    starter = models.ForeignKey(User, null=True, related_name='topics', on_delete=models.DO_NOTHING)
...
class Post(models.Model):
    message = models.TextField(default="message", max_length=4000)
    topic = models.ForeignKey(Topic, null=True, related_name='posts', on_delete=models.CASCADE)
    created_at = models.DateTimeField(null=True, auto_now_add=True)
    updated_at = models.DateTimeField(null=True)
    created_by = models.ForeignKey(User, null=True, related_name='posts', on_delete=models.DO_NOTHING)
